...
public class ComicBooks {
    ...
    public static void main(String[] args) {
        ...
        comix[0] = new Comic("Wspaniały Spider-Man", "1A",bookCondition.BARDZO_DOBRY,
                12_000.00F);
        comix[0].setPrice( (Float) quality.get(comix[0].condition) );
        comix[1] = new Comic("Niesamowity Hulk", "181", bookCondition.PRAWIE_JAK_NOWY,
                680.00F);
...
class Comic {
    ...
    Comic(String inTitle, String inIssueNumber, bookCondition inCondition,
          float inBasePrice) {
